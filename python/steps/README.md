...
- `../../protocol/specs/technical/yx-protocol-spec.md` - Protocol specification
- `../../protocol/specs/testing/testing-strategy.md` - Testing requirements
- `../../protocol/specs/architecture/implementation-languages.md` - Language guidance
