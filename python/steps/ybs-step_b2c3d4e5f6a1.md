...
Implements the GUID factory — a 6-byte cryptographically-secure identifier generator producing `src/yx/primitives/guid_factory.py` with full unit test coverage (≥19 tests).
...
**Implements**: protocol/specs/technical/yx-protocol-spec.md § Layer 2: GUID (6 bytes, offset 16-21)
...
```
STEP ybs-step_b2c3d4e5f6a1: GUID Factory Implementation
...
- src/yx/primitives/guid_factory.py
- tests/unit/test_guid_factory.py
