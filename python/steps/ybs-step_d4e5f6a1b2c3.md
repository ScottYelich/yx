...
Implements HMAC-SHA256 computation with 16-byte truncation and constant-time comparison for packet authentication, in `src/yx/primitives/data_crypto.py`. Prevents timing attacks via `hmac.compare_digest()`.
...
**Implements**: protocol/specs/technical/yx-protocol-spec.md § HMAC-SHA256 Integrity
**References**: protocol/specs/testing/testing-strategy.md § Category 3: Unit Tests (Security)
...
Implements: protocol/specs/testing/testing-strategy.md § Category 3: Unit Tests (Security)
"""
...
```
STEP ybs-step_d4e5f6a1b2c3: HMAC Computation
...
- src/yx/primitives/data_crypto.py
- tests/unit/test_data_crypto.py
