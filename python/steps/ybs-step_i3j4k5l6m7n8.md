...
**Traceability:**
- `protocol/specs/architecture/security-architecture.md` - Complete security specification
- `protocol/specs/technical/default-values.md` - Security defaults (CRITICAL: 10,000 req/60s, NOT 100!)
...
Implements the security layer: replay attack prevention (TTL-bounded seen-GUID store at 300s) and rate limiting (per-sender request counter at 10,000 req/60s), in `src/yx/security/`.
...
class ReplayProtection:
    ...
    Traceability:
    - protocol/specs/architecture/security-architecture.md (Replay Protection Algorithm)
    - protocol/specs/technical/default-values.md (replay_expiry, cleanup_threshold)
    ...
    def check_and_record(self, nonce: bytes) -> bool:
        ...
        Traceability:
        - protocol/specs/architecture/security-architecture.md (check_and_record)
        """
        now = time.time()
    ...
    def _cleanup(self, now: float):
        ...
        Traceability:
        - protocol/specs/architecture/security-architecture.md (Memory Management)
        """
        expired = [
...
Traceability:
- protocol/specs/architecture/security-architecture.md (Replay Protection Tests)
"""
...
class RateLimiter:
    ...
    def check_rate_limit(self, peer_id: str, source_addr: tuple) -> bool:
        ...
        Traceability:
        - protocol/specs/architecture/security-architecture.md (check_rate_limit)
        """
    ...
    def add_trusted_guid(self, guid_hex: str):
        ...
        Traceability:
        - protocol/specs/architecture/security-architecture.md (Trusted GUID Whitelist)
        """
...
Traceability:
- protocol/specs/architecture/security-architecture.md (Rate Limiting Tests)
"""
...
class KeyStore:
    ...
    def get_key(self, peer_id: str) -> bytes:
        ...
        Traceability:
        - protocol/specs/architecture/security-architecture.md (Lookup Algorithm)
        """
    ...
    def set_key(self, peer_id: str, key: bytes):
        ...
        Traceability:
        - protocol/specs/architecture/security-architecture.md (set_key)
        """
        if len(key) != 32:
...
- [ ] All defaults match protocol/specs/technical/default-values.md
...
1. ✅ Commit changes:
   ...
   Traceability: protocol/specs/architecture/security-architecture.md
...
**Specifications:**
- `protocol/specs/architecture/security-architecture.md` - Complete security spec
- `protocol/specs/technical/default-values.md` - Security defaults
- `protocol/specs/architecture/api-contracts.md` - Security APIs
...
Create `docs/build-history/ybs-step_-DONE.txt`:

```
STEP ybs-step_: ybs-step_i3j4k5l6m7n8
...
- src/yx/security/replay_window.py
- src/yx/security/rate_limiter.py
- tests/unit/test_security.py

VERIFICATION: PASSED (attempt [N])

NEXT STEP: ybs-step_j4k5l6m7n8o9 (SimplePacketBuilder)
```
