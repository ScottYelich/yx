...
Implements `SimplePacketBuilder` — a simplified facade over `PacketBuilder` for common packet operations, reducing boilerplate in tests and application code.
...
- [ ] API matches protocol/specs/architecture/api-contracts.md
...
- src/yx/transport/simple_packet_builder.py
- tests/unit/test_simple_packet_builder.py
