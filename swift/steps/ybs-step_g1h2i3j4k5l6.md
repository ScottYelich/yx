...
- ✅ Specifications: `protocol/specs/architecture/api-contracts.md`
...
Implements the Protocol 0 (text/JSON-RPC) handler in Swift — routing JSON-encoded messages over the YX transport layer.

## Traceability

**Specifications:**
- `protocol/specs/architecture/protocol-layers.md` § Protocol 0 (Text)
- `protocol/specs/technical/yx-protocol-spec.md` § Wire Format
- `protocol/specs/architecture/api-contracts.md` § RPC API
...
- `protocol/specs/architecture/protocol-layers.md` - Protocol stack design
- `protocol/specs/architecture/api-contracts.md` - RPC API specification
- `protocol/specs/technical/yx-protocol-spec.md` - Wire format
...
- Sources/YXProtocol/Protocol/TextHandler.swift
- Tests/YXProtocolTests/Unit/TextHandlerTests.swift
