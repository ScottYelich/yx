...
- ✅ Specifications: `protocol/specs/architecture/protocol-layers.md`
- ✅ Specifications: `protocol/specs/architecture/security-architecture.md`
...
Implements the Protocol 1 (binary/chunked) handler in Swift — supporting optional zlib compression and AES-256-GCM encryption using CryptoKit.

## Traceability

**Specifications:**
- `protocol/specs/architecture/protocol-layers.md` § Protocol 1 (Binary)
...
- `protocol/specs/technical/default-values.md` - Default chunk_size = 1024
...
- Sources/YXProtocol/Protocol/BinaryHandler.swift
- Tests/YXProtocolTests/Unit/BinaryHandlerTests.swift
