...
- ✅ Specifications: `protocol/specs/technical/default-values.md`
...
Implements the security layer using Swift actors: `actor ReplayWindow` for TTL-bounded seen-GUID tracking (300s) and `actor RateLimiter` for per-sender request counting (10,000/60s).
...
actor RateLimiter {
    ...
    /// See SDTS Issue #2 in protocol/specs/technical/default-values.md
...
- `protocol/specs/architecture/security-architecture.md` - Security architecture
- `protocol/specs/technical/default-values.md` - Default values and SDTS Issue #2
...
- Sources/YXProtocol/Security/ReplayWindow.swift
- Sources/YXProtocol/Security/RateLimiter.swift
- Tests/YXProtocolTests/Unit/SecurityTests.swift
