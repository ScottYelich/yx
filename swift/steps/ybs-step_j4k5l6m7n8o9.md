...
Implements `SimplePacketBuilder` — a Swift facade over `PacketBuilder` reducing boilerplate for common operations in tests and application code.
...
```
STEP ybs-step_: ybs-step_j4k5l6m7n8o9
...
- Sources/YXProtocol/Transport/SimplePacketBuilder.swift
- Tests/YXProtocolTests/Unit/SimplePacketBuilderTests.swift

VERIFICATION: PASSED (attempt [N])

NEXT STEP: ybs-step_k5l6m7n8o9p0 (Interoperability Tests)
```
