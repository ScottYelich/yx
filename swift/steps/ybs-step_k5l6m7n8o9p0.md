...
- ✅ Specifications: `protocol/specs/testing/interoperability-requirements.md`
...
Implements the interoperability test suite — the 48-test matrix validating Python↔Python, Python↔Swift, Swift↔Python, Swift↔Swift communication across all protocol layers with real UDP sockets.
...
- `protocol/specs/testing/interoperability-requirements.md` - Complete requirements
- `protocol/specs/architecture/api-contracts.md` - SimplePacketBuilder API
...
- Tests/YXProtocolTests/Interop/AllCombinationsTests.swift
