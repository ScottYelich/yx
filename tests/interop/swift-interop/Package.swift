...
// This package lives in tests/interop/swift-interop (not "swift") so its
// path-derived identity does not collide with the canonical/swift dependency.
...
let package = Package(
    ...
    dependencies: [
        .package(path: "../../../canonical/swift")
    ],
    targets: [
        // Transport Layer Senders
        .executableTarget(
            name: "swift-sender-transport-simple",
            dependencies: [.product(name: "YXProtocol", package: "swift")],
